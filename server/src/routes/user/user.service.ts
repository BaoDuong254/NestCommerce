...
import { CreateUserBodyType, GetUsersQueryType, UpdateUserBodyType } from "src/routes/user/models/user.model";
...
export class UserService {
  ...
  async create({
    ...
    try {
      // Verify role permissions, only admin can create admin user
